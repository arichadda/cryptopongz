        ...
        <>
            ...
            >
                ...
                <SpeedDialAction
                    key={'discord'}
                    icon={
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className={classes.icon} viewBox="0 0 16 16">
                    ...
                    onClick={handleClose}
                    href={'https://www.discord.com/invite/AkhcSkeN'}
                    target="_blank"
                    rel="noopener noreferrer"
                    underline="none"
                    color="inherit"
